...
Mobile.setText(findTestObject('Transfer/txt_Transfer Amount'), '5000', 0)
...
def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'You cannot make a transfer to the same account\']')
