...
Mobile.tap(findTestObject('All Header/btn_Help'), 0)

Mobile.verifyElementExist(findTestObject('All Header/prompt_Help Header'), 0)

Mobile.verifyElementExist(findTestObject('All Header/prompt_Help Text'), 0)
